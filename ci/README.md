...
Pipeline running at ${CONCOURSE_URL}/ops-tools-boshrelease
...
```
fly -t snw configure -c ci_image/pipeline.yml --vars-from credentials.yml ops-tools-boshrelease-image --paused=false
```
